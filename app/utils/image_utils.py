...
class ImageUtils:
    ...
    @staticmethod
    def enhance_image_quality(file_path: str, output_path: Optional[str] = None, max_size_mb: float = 4.0) -> str:
        """
        增強圖片品質
        ...
        try:
            ...
            with Image.open(file_path) as img:
                ...
                while quality > 70:  # 最低品質限制
                    ...
                    logger.info(f"增強後圖片大小: {enhanced_size:.2f}MB (品質: {quality})")
    ...
    @staticmethod
    def resize_image(file_path: str, max_width: int = 1920, max_height: int = 1080, 
    ...
    @staticmethod
    def create_thumbnail(file_path: str, size: Tuple[int, int] = (200, 200), 
                        output_path: Optional[str] = None) -> str:
        """
        創建縮圖
